...
export default function ProductTile({product, handleProductClick}) {
  ...
  return (
    <div
        ...
        className="w-[calc(25%-16px)] min-w-[200px] h-[220px] rounded-[10px] shadow-[0px_8px_10px_0px_#00000034] bg-white cursor-pointer transition-transform duration-300 hover:scale-[1.01] flex-grow"
    >
        ...
        <div className="flex flex-wrap gap-[5px] mt-1 px-[8px] justify-between items-center">
            <h3 className="font-[600] truncate">
                {product.title}
            </h3>
        ...
        <div className="flex justify-between items-center text-[0.9em] pt-1 px-[10px]">
