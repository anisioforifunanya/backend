...
export default function Job({job, checkAuth, isOuterPage}) {
  ...
  return (
    <div className='w-full min-h-[270px] rounded-2xl p-5 bg-[#ffe4dd] gap-2 shadow-lg flex flex-col justify-between'>
        <div>
            ...
            <button onClick={()=> isOuterPage? checkAuth(job.id) : push(`/home/jobs/${job.id}`)} className='p-3 bg-white text-red-800 rounded-lg border-red-800 border hover:border-b-4'>View Details</button>
        </div>
    </div>
  )
}
