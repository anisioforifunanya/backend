...
import { approveUser, dismissUser, rejectUser } from '@/services/adminService';
               ...
               {data.social_links?.length > 0 && <div>
                ...
                <div className="flex w-full gap-3 items-center flex-wrap justify-center">
                    ...
                    <button 
                        ...
                        className="p-3 bg-[#3db026] hover:bg-green-800 transition text-lg flex-1 min-w-[200px] font-semibold rounded-xl">
                            Approve Request
                    </button>
                </div>
                <Modal
                ...
                >
                    <p className='font-semibold my-3'>Are you sure you want to approve this user</p>

                    <div className="flex gap-2">
                    <button 
                        onClick={handleApprove} 
                        className={`p-3 rounded ${approvePending ? 'bg-[#545454] text-white' : 'bg-[#59ff00] text-black'} font-semibold w-[48%] flex items-center justify-center gap-2`}>{approvePending? <>Loading <Loader /></>: 'Approve Request'}</button>
                    <button 
