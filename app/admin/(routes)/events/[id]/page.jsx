...
export default function page({ params }) {
  ...
  return (
    <div className={`${styles.eventDetail} h-full`}>
      <div className="h-full">
       {data? (
           <>
                <SectionHeader text={data?.title} canUpdate={true} id={data?.id} />
               ...
               <div className="flex justify-between items-center">
                  ...
                  <p 
                      className="p-2 border border-red-800 text-red-800 flex place-items-center rounded w-fit cursor-pointer my-2 bg-white">{eventCategoryIcons(data?.category)}{
                    AllEventCategories
               ...
               {data?.virtual_url ? 
                <a 
                    className="flex place-items-center gap-1 hover:underline cursor-pointer w-fit" 
